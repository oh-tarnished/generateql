...
func (r *FindRequest) OrderBy(v ...graphql.OrderTerm) *FindRequest { r.orderBy = v; return r }
...
// OrderBy sets the result ordering.
func (r *OnFindRequest) OrderBy(v ...graphql.OrderTerm) *OnFindRequest { r.orderBy = v; return r }
