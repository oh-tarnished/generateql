...
func (r *renderer) mutationAssert(rg *resGen) string {
	...
	if sharedRequestType(*createOp, r.classify(*createOp)) != "CreateRequest" ||
		sharedRequestType(*updateOp, r.classify(*updateOp)) != "UpdateRequest" ||
		sharedRequestType(*deleteOp, r.classify(*deleteOp)) != "DeleteRequest" {
		return ""
	}
...
func (r *renderer) listMatchesGeneric(o op) bool {
	...
	return sharedRequestType(o, specs) == "ListRequest"
}
