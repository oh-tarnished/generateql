...
func (r *renderer) qualifiesIfMatch(o op) bool {
	if o.FindOne || o.Op.Kind != "mutation" || !strings.HasPrefix(o.Op.Name, "update") {
		return false
	}
...
func (r *renderer) hasPreCheck(o op) bool {
	for _, a := range o.Op.Args {
		if (a.Name == "preCheck" || a.Name == "pre_check") && r.isBoolExp(a.Type.Base) {
			return true
		}
	}
	return false
...
func (r *renderer) affectedRowsField(o op) string {
	...
	for _, f := range obj.Fields {
		if f.Name == "affectedRows" || f.Name == "affected_rows" {
